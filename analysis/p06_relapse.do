...
forval j=1/2 {
  forval i=1/4 {
    count if _d==1 & b6_q4==`i' & fail_strata==`j'
    mat counts[`iter', 1] = r(N)
    local ++iter
  }
}

stcox i.b6_q4##fail_strata `minadj', strata(fail_strata country)
testparm i(2/4).b6_q4#2.fail_strata
local p_interaction = r(p)
nlcom (_b[1.b6_q4]) (_b[2.b6_q4]) (_b[3.b6_q4]) (_b[4.b6_q4]) ///
      (_b[1.b6_q4] + _b[1b.b6_q4#2.fail_strata]) ///
      (_b[2.b6_q4] + _b[2.b6_q4#2.fail_strata]) ///
      (_b[3.b6_q4] + _b[3.b6_q4#2.fail_strata]) ///
      (_b[4.b6_q4] + _b[4.b6_q4#2.fail_strata]) 
mata
b = st_matrix("r(b)")
V = st_matrix("r(V)")
...
stcox i.b6_q4##fail_strata `adj', strata(fail_strata country)
testparm i(2/4).b6_q4#2.fail_strata
local p_interaction = r(p)
nlcom (_b[1.b6_q4]) (_b[2.b6_q4]) (_b[3.b6_q4]) (_b[4.b6_q4]) ///
      (_b[1.b6_q4] + _b[1b.b6_q4#2.fail_strata]) ///
