%% vitamin B6 and survival from Kidney cancer (K2 study)
%% tables and figures
...
\centering
\input{../analysis/output/o07_descriptive_by_vitstat.tex}
\end{table}
...
\includegraphics[width=14cm]{../analysis/output/g08_interactions.pdf}
\end{figure}


%% Model based survival by b6 and stage
\begin{figure}
 \centering 
...
\includegraphics[width=14cm]{../analysis/output/g05_surv_b6_stage.pdf}
\end{figure}
...
$p$ \\
\midrule
\input{../analysis/output/o06_hr_table_relapse.tex}
\bottomrule
\end{tabular}
\newline
{\footnotesize 
