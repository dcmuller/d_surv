...
Per Magne Ueland$^{8, 9}$, Paul Brennan$^1$, Ghislaine Scelo$^1$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
\noindent \textbf{Background:} We evaluate if concentrations of vitamin 
...
25-Hydroxyvitamin D$_3$ [25(OH)D$_3$], and weighted Cox models were used to 
estimate 
...
of RCC was inversely associated with all-cause mortality rates. \newline
...
kidney cancer, an observation consistent with a recent study, in which 
...
concentrations measured at kidney cancer diagnosis are associated with 
