...
clear all
capture log close
log using ./analysis/output/l03_hr_table.log, replace
version 12.1
********************************************************
...
keep if _n<=12
outsheet using ./analysis/output/o03_hr_table.csv, c replace
listtex using ./analysis/output/o03_hr_table.tex, replace rstyle(tabular)
