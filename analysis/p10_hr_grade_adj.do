...
local adj "`minadj' i.grade bmi_current smoke_qty_day i.smoke_status alc_day i.alcohol_status"
...
mat counts = J(4, 1, .)
forval i=1/4 {
  count if _d==1 & b6_q4==`i' & insample
  mat counts[`i', 1] = r(N)
}
...
forval j=1/2 {
  forval i=1/4 {
    count if _d==1 & b6_q4==`i' & death_strata==`j' & insample
